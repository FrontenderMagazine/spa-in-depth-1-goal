...
**Представления наблюдают за изменениями модели.** Нам нужно чтобы Представления отражали содержимое Моделей. Когда несколько Представлений зависят от одной Модели (к примеру, нам нужно перерисовать Представления при изменении в Модели), мы не хотим в ручную следить за каждым зависимым Представлением. Вместо этого есть система событий, через которую Представления получают оповещение об изменении от Модели и они перерисовываются сами.
